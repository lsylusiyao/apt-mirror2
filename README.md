...
Verified incremental transfer supports every external/internal host combination
of Linux and Windows (the external Windows workflow uses WSL). It can synchronize
